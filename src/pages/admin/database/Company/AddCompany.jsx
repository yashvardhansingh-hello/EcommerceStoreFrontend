...
import { useAddCompanyMutation } from "../../../../features/api";
...
const AddCompany = () => {
  ...
  const [addCompanyMutation] = useAsyncMutation(useAddCompanyMutation);
  ...
  const addCompanyHandler = async () => {
    ...
    await addCompanyMutation("updating company ...", formdata);
...
export default AdminLayout()(AddCompany);

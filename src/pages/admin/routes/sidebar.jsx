...
const routes = [
  ...
  },
  {
    ...
    submenu: [
      {
        path: "/admin/product",
        icon: <ShoppingBag className={submenuIconClasses} />,
        name: "Products",
      },
      {
        path: "/admin/category", //url
        
        icon: <DocumentChartBar className={submenuIconClasses} />, // icon component
        name: "Category", // name that appear in Sidebar
      },
      {
        path: "/admin/company",
        icon: <BuildingOffice className={submenuIconClasses} />,
        name: "Company",
      },
    ],
  },
  ...
  // },
  {
    path: "/admin/settings", //no url needed as this has submenu
